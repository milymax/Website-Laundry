...
if($_POST){
    ...
    if(empty($nama)){
        echo "<script>alert('nama member tidak boleh kosong');location.href='ubah.php';</script>";
    }else {
    include "../koneksi.php";
    
    $update=mysqli_query($conn,"update member set nama ='".$nama."',alamat='".$alamat."',jenis_kelamin='".$jenis_kelamin."',
